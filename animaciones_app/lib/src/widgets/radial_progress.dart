...
class RadialProgress extends StatefulWidget {
  ...
  RadialProgress({required this.porcentaje, this.colorPrimario = Colors.blue, this.colorSecundario = Colors.black, this.grosorPrimario = 10.0,this.grosorSecundario = 4.0 });
